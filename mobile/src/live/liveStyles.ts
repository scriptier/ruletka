...
export const liveStyles = StyleSheet.create({
  ...
  /** 2v2 party: extras top, you+teammate bottom. Absolute so first RTCView stays mounted. */
  gridSlotTL: {
    position: "absolute",
    left: 0,
    top: 0,
  ...
  /** Dark floor under Stop — 3D lip (PC dock-pill.danger). */
  btnStopFloor: {
    flex: 0.95,
    borderRadius: 999,
  ...
  btnStopFace: {
    ...
    justifyContent: "center",
    borderWidth: 1.5,
    borderColor: "rgba(255, 90, 130, 0.55)",
    overflow: "hidden",
  },
  btnStopText: {
    color: "#ffd0dc",
  ...
  /** Coral floor under Next — 3D lip matching web `#btn-next.next-in-tile-floor`. */
  btnNextFloor: {
    flex: 1.35,
    borderRadius: 999,
    backgroundColor: "#9e1230",
    paddingBottom: 4,
  },
  ...
  btnNext: {
    ...
    justifyContent: "center",
    borderWidth: 1,
    borderColor: "rgba(255, 210, 200, 0.55)",
    overflow: "hidden",
  },
  btnNextText: {
    color: "#fff",
    ...
    textAlign: "center",
    includeFontPadding: false,
    textShadowColor: "rgba(90, 0, 20, 0.45)",
    textShadowOffset: { width: 0, height: 1 },
    textShadowRadius: 0,
  },
  btnGhost: {
  ...
  /** Idle Start on brand diamond (~PC 81%). */
  idleArcadeWrap: {
    position: "absolute",
    left: 0,
    right: 0,
  ...
  idleArcadeHalo: {
    ...
    height: 62,
    borderRadius: 999,
    backgroundColor: "rgba(232, 196, 120, 0.35)",
    top: -4,
  },
  idleArcadeBtn: {
    minWidth: 168,
    ...
    backgroundColor: "#ff2d55",
    borderWidth: 1.5,
    borderColor: "rgba(242, 214, 150, 0.92)",
    alignItems: "center",
    justifyContent: "center",
    shadowColor: "#6e0c22",
  ...
  idleArcadeBtnPressed: {
    transform: [{ translateY: 6 }],
    backgroundColor: "#d0163c",
  },
  idleArcadeText: {
    color: "#fff",
    fontSize: 20,
