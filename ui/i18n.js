...
(function (global) {
  ...
  const STR = {
    en: {
      ...
      "msg.emptyFriends": "No friends yet. Add a code under Friends, then message them here.",
    ...
    ru: {
      ...
      "msg.emptyFriends": "Пока нет друзей. Добавьте код в Друзьях, затем напишите здесь.",
  ...
  function loadPack(code) {
    ...
    loading[c] = fetch(`/i18n/${c}.json?v=22`, { cache: "force-cache" })
      .then((r) => {
