...
(function (global) {
  ...
  const STR = {
    ...
    ru: {
      ...
      "avatar.change": "Фото",
      "avatar.changeTitle": "Выбрать маленькое фото профиля",
      "avatar.clear": "Убрать",
      "avatar.saved": "Фото сохранено",
      "avatar.cleared": "Фото удалено",
      "avatar.fail": "Не удалось использовать изображение",
      "avatar.tooLarge": "Слишком большой файл (макс. 5 МБ)",
